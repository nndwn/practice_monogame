...
public readonly struct Circle : IEquatable<Circle>
{
    ...
    /// <summary>
    /// The X-coordinate of ther center of this circle.
    /// </summary>
    ...
    /// <summary>
    /// Gets a value that indicates whether this circle has a radius of 0 and location of(0,0).
    /// </summary>
    public readonly bool IsEmpty => X == 0 && Y == 0 && Radius == 0;
    /// <summary>
    /// Gets the y-coordinate of the highest point on this circle   public readonly int Top => Y - Radius;
    /// </summary>
    ...
    /// <summary>
    /// Gets the x-coordinate of the rightmost point of this circle.
    /// </summary>
    ...
    /// <param name="radius">The length from the center of circle to an edge.</param>
    ...
    /// <summary>
    /// Returns the hash cide for this circle.
    /// </summary>
